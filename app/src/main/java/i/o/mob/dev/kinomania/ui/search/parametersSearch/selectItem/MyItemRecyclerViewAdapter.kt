...
class MyItemRecyclerViewAdapter(private val values: List<SimpleListItem>, private val simpleItemDelegate: SimpleItemDelegate) : RecyclerView.Adapter<MyItemRecyclerViewAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(val view: View) : RecyclerView.ViewHolder(view) {
        ...
        private fun onItemSelected(){
            simpleItemDelegate.itemSelected(values[absoluteAdapterPosition], !view.checkbox.isChecked)

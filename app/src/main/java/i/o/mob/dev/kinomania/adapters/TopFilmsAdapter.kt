...
import i.o.mob.dev.kinomania.data.TopFilms
...
class TopFilmsAdapter : RecyclerView.Adapter<TopFilmsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return when(viewType){
            TYPE_CONTENT -> { ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_movie_card, parent, false)) }
            TYPE_LOAD_MORE -> { ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_load_more_card, parent, false)) }
            else -> { ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_movie_card, parent, false)) }
        }

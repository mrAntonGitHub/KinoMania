...
class FilmsGridAdapter : RecyclerView.Adapter<FilmsGridAdapter.ViewHolder>() {
            ...
            TYPE_CONTENT -> {
                ViewHolder(
                    LayoutInflater.from(parent.context)
                        .inflate(R.layout.item_grid_movie_card, parent, false)
                )
            }
            TYPE_LOAD_MORE -> {
                ViewHolder(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        when (getItemViewType(position)) {
            ...
            TYPE_LOAD_MORE -> {
                holder.apply {
                    this.item.layoutParams.width =
                        this.itemView.context.resources.getDimension(R.dimen.movie_card_width_grid)
                            .toInt()
                    this.item.layoutParams.height =
                        this.itemView.context.resources.getDimension(R.dimen.movie_card_height_grid)
                            .toInt()
